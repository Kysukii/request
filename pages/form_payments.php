  ...
  ?>
    ...
    function calcularTotal() {
      ...
      for (var i = 0; i < inputs.length; i++) {
        if (inputs[i].value !== '') {
          parseFloat(inputs[i].value.replace('R$ ', '').replace('.', '').replace(',', '.'))
          total += formatarNumero(inputs[i].value);
        }
      }

      document.getElementById('valorTotalParcela').value = 'R$' + formatarValor(total.toFixed(2).replace('.', ','));
  ...
  <div id="liveToast" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
    ...
    <div class="container my-5">
      ...
      <div class="col-lg-8 px-0">
        <form id="register_payment" action="send_payments.php" method="POST">
        ...
        <div class="row">
          ...
          <div class="col-4 mb-3" style="text-align: center;">
            ...
            <div class="row gap-2 d-flex justify-content-center">
              <button class="btn btn-primary col-4" id="btnAdicionarCategoria">ADD</button>
              <button class="btn btn-danger col-4" id="btnRemoverCategoria">DEL</button>
            </div>
          </div>
        </div>
          ...
          <div id="containerCategorias" >
            <div class="row">
              ...
              <div class="col-4 mb-3">
                ...
                <input type="text" class="form-control catval" name="valor[]" placeholder="Valor monetário" onblur="calcularTotal()">
              </div>
            </div>
          </div>
        </div> 
        ...
        <div class="row">
          ...
          <div class="col-4 mb-2">
            <label for="ValTotalParcela" class="form-label">Valor Total:</label>
        ...
        <div id="containerParcelas">
          ...
          <input id="sendFormBtn" class="btn btn-primary" type="submit" value="Enviar" name="Senfbts"/>
        </form>
...
$('#register_payment').submit(function(event) {
  ...
  if (event.originalEvent.submitter && event.originalEvent.submitter.id === 'sendFormBtn') {
    $('#register_payment [disabled]').removeAttr('disabled');
